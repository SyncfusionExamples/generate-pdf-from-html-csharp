# Generate PDF documents from dynamic HTML using Syncfusion&reg; PDF generator API 

The [Syncfusion&reg; HTML-to-PDF converter library](https://www.syncfusion.com/document-processing/pdf-framework/net/html-to-pdf) in combination with [ASP.NET Core Minimal Web API](https://learn.microsoft.com/en-us/aspnet/core/tutorials/min-web-api?view=aspnetcore-7.0&tabs=visual-studio) offers a simple and straightforward approach for dynamically generating PDFs from HTML templates. 

In this repository, we will learn how to create an ASP.NET Core Minimal Web API that dynamically generates a PDF document from an HTML template using Syncfusion&reg; HTML-to-PDF converter library.  
